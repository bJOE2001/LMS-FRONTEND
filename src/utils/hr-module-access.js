export const HR_MODULE_KEYS = Object.freeze({
  ...
  receiving: 'receiving',
  releasing: 'releasing',
  cancelledApplications: 'cancelled_applications',
...
const HR_MODULE_ROUTE_REQUIREMENTS = [
  ...
  { prefix: '/hr/releasing', moduleKey: HR_MODULE_KEYS.releasing },
  { prefix: '/hr/cancelled-applications', moduleKey: HR_MODULE_KEYS.cancelledApplications },
...
const HR_MODULE_NAV_PRIORITY = [
  ...
  { moduleKey: HR_MODULE_KEYS.releasing, path: '/hr/releasing' },
  { moduleKey: HR_MODULE_KEYS.cancelledApplications, path: '/hr/cancelled-applications' },
