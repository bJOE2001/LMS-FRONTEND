<template>
  <BaseAnalyticsChart title="Gender Distribution" subtitle="Workforce gender profile" type="donut" :height="320" :loading="loading" :series="chart.series" :options="options" />
</template>
...
const options = computed(() => buildDonutOptions({
